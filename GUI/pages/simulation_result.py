...
_INTERVALTEXTPACKCODES = {auxiliaries.KLINE_INTERVAL_ID_1m:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_1M',
                          ...
                          auxiliaries.KLINE_INTERVAL_ID_5m:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_5M',
                          auxiliaries.KLINE_INTERVAL_ID_15m: 'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_15M',
                          auxiliaries.KLINE_INTERVAL_ID_30m: 'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_30M',
                          auxiliaries.KLINE_INTERVAL_ID_1h:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_1H',
                          auxiliaries.KLINE_INTERVAL_ID_2h:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_2H',
                          auxiliaries.KLINE_INTERVAL_ID_4h:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_4H',
                          auxiliaries.KLINE_INTERVAL_ID_6h:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_6H',
                          auxiliaries.KLINE_INTERVAL_ID_8h:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_8H',
                          auxiliaries.KLINE_INTERVAL_ID_12h: 'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_12H',
                          auxiliaries.KLINE_INTERVAL_ID_1d:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_1D',
                          auxiliaries.KLINE_INTERVAL_ID_3d:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_3D',
                          auxiliaries.KLINE_INTERVAL_ID_1W:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_1W',
                          auxiliaries.KLINE_INTERVAL_ID_1M:  'SIMULATIONRESULT:SIMULATIONDETAIL_CONFIGURATIONS_CURRENCYANALYSISCONFIGURATIONINTERVAL_1MONTH'}
    ...
    if (self.displaySpaceDefiner['ratio'] == '16:9H'):
        ...
        if (True):
            ...
            if (True):
                ...
                yPosPoint0 = yPos_beg
                spo.addGUIO("TITLE_MAININDICATORS", passiveGraphics_wrapperTypeC, {'groupOrder': 0, 'xPos': 0, 'yPos': yPosPoint0, 'width': subPageViewSpaceWidth, 'height': 200, 'style': 'styleB', 'text': self.visualManager.getTextPack('SIMULATIONRESULT:BLOCKSUBTITLE_SIMULATIONDETAIL_CONFIGURATIONS_MAININDICATORS'), 'fontSize': 80})
                ...
                spo.addGUIO("TITLE_SUBINDICATORS", passiveGraphics_wrapperTypeC, {'groupOrder': 0, 'xPos': 0, 'yPos': yPosPoint1, 'width': subPageViewSpaceWidth, 'height': 200, 'style': 'styleB', 'text': self.visualManager.getTextPack('SIMULATIONRESULT:BLOCKSUBTITLE_SIMULATIONDETAIL_CONFIGURATIONS_SUBINDICATORS'), 'fontSize': 80})
                ...
                spo.addGUIO("TITLE_OTHERS", passiveGraphics_wrapperTypeC, {'groupOrder': 0, 'xPos': 0, 'yPos': yPosPoint2, 'width': subPageViewSpaceWidth, 'height': 200, 'style': 'styleB', 'text': self.visualManager.getTextPack('SIMULATIONRESULT:BLOCKSUBTITLE_SIMULATIONDETAIL_CONFIGURATIONS_OTHERS'), 'fontSize': 80})
                ...
                for amType, am in analyzers.ANALYSES.items():
                    ...
                    #[2]: Page TItle Object
                    sp.addGUIO("CONFIGPAGETITLE", passiveGraphics_wrapperTypeC, {'groupOrder': 0, 'xPos': 0, 'yPos': yPos_beg-200, 'width': subPageViewSpaceWidth, 'height': 200, 'style': 'styleB', 'text': self.visualManager.getTextPack(f'SIMULATIONRESULT:BLOCKSUBTITLE_SIMULATIONDETAIL_CONFIGURATIONS_{amType:s}SETUP'), 'fontSize': 80})
...
def __generateAuxillaryFunctions(self):
    ...
    def __updateSimulationSummaryAsset():
        ...
        if (_simulation_summary_asset != None):
            ...
            if (asset_selected == 'total'):
                ...
                self.GUIOs["RESULTSUMMARY_GAINSDISPLAYTEXT"].updateText(text  = f"{auxiliaries.floatToString(number = _gains,      precision = _ASSETPRECISIONS_XS[asset_selected])} {asset_selected}")
                self.GUIOs["RESULTSUMMARY_LOSSESDISPLAYTEXT"].updateText(text = f"{auxiliaries.floatToString(number = _losses,     precision = _ASSETPRECISIONS_XS[asset_selected])} {asset_selected}")
                self.GUIOs["RESULTSUMMARY_FEESDISPLAYTEXT"].updateText(text   = f"{auxiliaries.floatToString(number = _tradingFee, precision = _ASSETPRECISIONS_XS[asset_selected])} {asset_selected}")
                #Net Profit
                ...
                _wb_initial_str = auxiliaries.floatToString(number = _simulation_summary_asset['walletBalance_initial'], precision = _ASSETPRECISIONS_XS[asset_selected])
                _wb_final_str   = auxiliaries.floatToString(number = _simulation_summary_asset['walletBalance_final'],   precision = _ASSETPRECISIONS_XS[asset_selected])
                ...
                _wb_min_str = auxiliaries.floatToString(number = _simulation_summary_asset['walletBalance_min'], precision = _ASSETPRECISIONS_XS[asset_selected])
                _wb_max_str = auxiliaries.floatToString(number = _simulation_summary_asset['walletBalance_max'], precision = _ASSETPRECISIONS_XS[asset_selected])
    ...
    def __updateAssetDataDisplay_AssetPositionSetup():
        if (self.puVar['simulation_selected'] != None):
            ...
            else:                                                 self.GUIOs["SIMULATIONDETAIL_ASSETPOSITIONSETUP_ASSETS_MAXALLOCATEDBALANCEDISPLAYTEXT"].updateText(text = auxiliaries.floatToString(number = _asset['maxAllocatedBalance'], precision = _ASSETPRECISIONS_S[_assetName_selected]))
        else:
