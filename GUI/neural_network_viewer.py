...
class neuralNetworkViewer:
    ...
    def __configureSettingsSubPageObjects(self):
        ...
        if (True):
            yPos_beg = 20000
            #Title
            self.settingsSubPage.addGUIO("TITLE_MAIN", generals.passiveGraphics_wrapperTypeB, {'groupOrder': 0, 'xPos': 0, 'yPos': yPos_beg, 'width': subPageViewSpaceWidth, 'height': 200, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_NEURALNETWORKVIEWER:TITLE_VIEWERSETTINGS')})
            yPosPoint0 = yPos_beg-350
            self.settingsSubPage.addGUIO("LINECOLOR_TITLE",           generals.passiveGraphics_wrapperTypeC, {'groupOrder': 0, 'xPos':    0, 'yPos': yPosPoint0, 'width': subPageViewSpaceWidth, 'height': 250, 'style': 'styleB', 'text': self.visualManager.getTextPack('GUIO_NEURALNETWORKVIEWER:LINE'), 'fontSize': 90, 'anchor': 'SW'})
            self.settingsSubPage.addGUIO("LINECOLOR_TEXT",            generals.textBox_typeA,      {'groupOrder': 0, 'xPos':    0, 'yPos': yPosPoint0-350, 'width':  600, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_CHARTDRAWER:LINETARGET'), 'fontSize': 80})
            self.settingsSubPage.addGUIO("LINECOLOR_TARGETSELECTION", generals.selectionBox_typeB, {'groupOrder': 2, 'xPos':  700, 'yPos': yPosPoint0-350, 'width': 1500, 'height': 250, 'style': 'styleA', 'name': 'LineSelectionBox', 'nDisplay': 5, 'fontSize': 80, 'selectionUpdateFunction': self.__onSettingsContentUpdate})
            self.settingsSubPage.addGUIO("LINECOLOR_LED",             generals.LED_typeA,          {'groupOrder': 0, 'xPos': 2300, 'yPos': yPosPoint0-350, 'width':  950, 'height': 250, 'style': 'styleA', 'mode': True})
            self.settingsSubPage.addGUIO("LINECOLOR_APPLYCOLOR",      generals.button_typeA,       {'groupOrder': 0, 'xPos': 3350, 'yPos': yPosPoint0-350, 'width':  650, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_CHARTDRAWER:APPLYCOLOR'), 'fontSize': 80, 'name': 'ApplyColor', 'releaseFunction': self.__onSettingsContentUpdate})
            for index, componentType in enumerate(('R', 'G', 'B')):
                self.settingsSubPage.addGUIO("LINECOLOR_{:s}_TEXT".format(componentType),   generals.textBox_typeA, {'groupOrder': 0, 'xPos':    0, 'yPos': yPosPoint0-700-350*index, 'width':  500, 'height': 250, 'style': 'styleA', 'text': componentType, 'fontSize': 80})
                self.settingsSubPage.addGUIO("LINECOLOR_{:s}_SLIDER".format(componentType), generals.slider_typeA,  {'groupOrder': 0, 'xPos':  600, 'yPos': yPosPoint0-650-350*index, 'width': 2600, 'height': 150, 'style': 'styleA', 'name': 'Color_{:s}'.format(componentType), 'valueUpdateFunction': self.__onSettingsContentUpdate})
                self.settingsSubPage.addGUIO("LINECOLOR_{:s}_VALUE".format(componentType),  generals.textBox_typeA, {'groupOrder': 0, 'xPos': 3300, 'yPos': yPosPoint0-700-350*index, 'width':  700, 'height': 250, 'style': 'styleA', 'text': "-", 'fontSize': 80})
            yPosPoint1 = yPosPoint0-1400
            self.settingsSubPage.addGUIO("LINECOLOR_POSITIVE_TEXT",    generals.textBox_typeA, {'groupOrder': 0, 'xPos':    0, 'yPos': yPosPoint1-350, 'width': 1100, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_NEURALNETWORKVIEWER:LINEPOSITIVE'), 'fontSize': 80})
            self.settingsSubPage.addGUIO("LINECOLOR_POSITIVE_COLOR",   generals.LED_typeA,     {'groupOrder': 0, 'xPos': 1200, 'yPos': yPosPoint1-350, 'width':  750, 'height': 250, 'style': 'styleA', 'mode': True})
            self.settingsSubPage.addGUIO("LINECOLOR_NEGATIVE_TEXT",    generals.textBox_typeA, {'groupOrder': 0, 'xPos': 2050, 'yPos': yPosPoint1-350, 'width': 1100, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_NEURALNETWORKVIEWER:LINENEGATIVE'), 'fontSize': 80})
            self.settingsSubPage.addGUIO("LINECOLOR_NEGATIVE_COLOR",   generals.LED_typeA,     {'groupOrder': 0, 'xPos': 3250, 'yPos': yPosPoint1-350, 'width':  750, 'height': 250, 'style': 'styleA', 'mode': True})
            self.settingsSubPage.addGUIO("LINECOLOR_NEUTRAL_TEXT",     generals.textBox_typeA, {'groupOrder': 0, 'xPos':    0, 'yPos': yPosPoint1-700, 'width': 1100, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_NEURALNETWORKVIEWER:LINENEUTRAL'),  'fontSize': 80})
            self.settingsSubPage.addGUIO("LINECOLOR_NEUTRAL_COLOR",    generals.LED_typeA,     {'groupOrder': 0, 'xPos': 1200, 'yPos': yPosPoint1-700, 'width':  750, 'height': 250, 'style': 'styleA', 'mode': True})
            self.settingsSubPage.addGUIO("LINECOLOR_INPUTLAYER_TEXT",  generals.textBox_typeA, {'groupOrder': 0, 'xPos': 2050, 'yPos': yPosPoint1-700, 'width': 1100, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_NEURALNETWORKVIEWER:INPUTLAYER'),   'fontSize': 80})
            self.settingsSubPage.addGUIO("LINECOLOR_INPUTLAYER_COLOR", generals.LED_typeA,     {'groupOrder': 0, 'xPos': 3250, 'yPos': yPosPoint1-700, 'width':  750, 'height': 250, 'style': 'styleA', 'mode': True})
            self.settingsSubPage.addGUIO("LINEWIDTH_TEXT",      generals.textBox_typeA,      {'groupOrder': 0, 'xPos':    0, 'yPos': yPosPoint1-1050, 'width': 2900, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_NEURALNETWORKVIEWER:LINEWIDTH'), 'fontSize': 80})
            self.settingsSubPage.addGUIO("LINEWIDTH_TEXTINPUT", generals.textInputBox_typeA, {'groupOrder': 0, 'xPos': 3000, 'yPos': yPosPoint1-1050, 'width': 1000, 'height': 250, 'style': 'styleA', 'name': 'WidthTextInputBox', 'text': "", 'fontSize': 80, 'textUpdateFunction': self.__onSettingsContentUpdate})
            self.settingsSubPage.addGUIO("APPLYNEWSETTINGS",  generals.button_typeA, {'groupOrder': 0, 'xPos': 0, 'yPos': yPosPoint1-1400, 'width': subPageViewSpaceWidth, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_NEURALNETWORKVIEWER:APPLYSETTINGS'), 'fontSize': 80, 'name': 'ApplySettings',   'releaseFunction': self.__onSettingsContentUpdate})
            self.settingsSubPage.addGUIO("SAVECONFIGURATION", generals.button_typeA, {'groupOrder': 0, 'xPos': 0, 'yPos': yPosPoint1-1750, 'width': subPageViewSpaceWidth, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_NEURALNETWORKVIEWER:SAVECONFIG'),    'fontSize': 80, 'name': 'SAVECONFIG', 'releaseFunction': self.__onSettingsContentUpdate})
            #GUIO Setup
            _targetList = dict()
        ...
        if (True):
            if (onInit == True):
                ...
                if (True):
                    ...
                    self.hitBox['SBF'] = hit_boxes.hitBox_Rectangular(_displayBox[0], _displayBox[1], _displayBox[2], _displayBox[3])
