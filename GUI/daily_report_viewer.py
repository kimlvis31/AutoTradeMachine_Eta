...
class dailyReportViewer:
    ...
    def __configureSettingsSubPageObjects(self):
        ...
        if (True):
            yPos_beg = 20000
            #Title
            self.settingsSubPage.addGUIO("TITLE_MAIN", generals.passiveGraphics_wrapperTypeB, {'groupOrder': 0, 'xPos': 0, 'yPos': yPos_beg, 'width': subPageViewSpaceWidth, 'height': 200, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_DAILYREPORTVIEWER:TITLE_VIEWERSETTINGS')})
            yPosPoint0 = yPos_beg-350
            self.settingsSubPage.addGUIO("DISPLAYMODE_TEXT",         generals.textBox_typeA,      {'groupOrder': 0, 'xPos':    0, 'yPos':  yPosPoint0,     'width': 1750, 'height': 250, 'style': 'styleB', 'text': self.visualManager.getTextPack('GUIO_DAILYREPORTVIEWER:DISPLAYMODE'), 'fontSize': 80})
            ...
            self.settingsSubPage.addGUIO("TIMEZONE_TEXT",            generals.textBox_typeA,      {'groupOrder': 0, 'xPos':    0, 'yPos':  yPosPoint0-350, 'width': 1750, 'height': 250, 'style': 'styleB', 'text': self.visualManager.getTextPack('GUIO_DAILYREPORTVIEWER:TIMEZONE'), 'fontSize': 80})
            ...
            self.settingsSubPage.addGUIO("LINECOLOR_TITLE",     generals.passiveGraphics_wrapperTypeC, {'groupOrder': 0, 'xPos':    0, 'yPos': yPosPoint1, 'width': subPageViewSpaceWidth, 'height': 250, 'style': 'styleB', 'text': self.visualManager.getTextPack('GUIO_DAILYREPORTVIEWER:LINE'), 'fontSize': 90, 'anchor': 'SW'})
            self.settingsSubPage.addGUIO("LINECOLOR_TEXT",      generals.textBox_typeA,                {'groupOrder': 0, 'xPos':    0, 'yPos': yPosPoint1-350, 'width': 900, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_DAILYREPORTVIEWER:COLOR'), 'fontSize': 80})
            ...
            self.settingsSubPage.addGUIO("LINEWIDTH_TEXT",      generals.textBox_typeA,                {'groupOrder': 0, 'xPos': 2050, 'yPos': yPosPoint1-350, 'width': 900, 'height': 250, 'style': 'styleA', 'text': self.visualManager.getTextPack('GUIO_DAILYREPORTVIEWER:WIDTH'), 'fontSize': 80})
            ...
            if (onInit == True):
                for displayBoxName in self.displayBox:
                    ...
                    #---MAIN
                        ...
                        self.displayBox_graphics['MAIN']['DESCRIPTIONTEXT3'] = text_control.textObject_SL(scaler = self.scaler, batch = self.batch, group = self.group_hd0, text = self.visualManager.extractText(self.visualManager.getTextPack('GUIO_DAILYREPORTVIEWER:{:s}'.format(self.data_DisplayMode))), 
                                                                                                                    defaultTextStyle = self.effectiveTextStyle['CONTENT_DEFAULT'], auxillaryTextStyles = self.effectiveTextStyle,
