...
class DataManager:
    ...
    def __init__(self, path_project, ipcA):
        ...
        self.__workers = {'market':        market.Worker(path_project        = path_project, dmConfig = dmConfig, ipcA = ipcA, portNumber = pgPortNumber),
                          'account':       account.Worker(path_project       = path_project, dmConfig = dmConfig, ipcA = ipcA),
                          'simulation':    simulation.Worker(path_project    = path_project, dmConfig = dmConfig, ipcA = ipcA),
                          'neuralNetwork': neural_network.Worker(path_project = path_project, dmConfig = dmConfig, ipcA = ipcA)}
