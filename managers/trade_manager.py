...
class TradeManager:
    ...
    def __far_onAnalysisGeneration(self, requester, currencyAnalysisCode, linearizedAnalysis):
        ...
        if ca_analysisResults['lastReceived'] is not None:
            ...
            klineTS_expected = auxiliaries.getNextIntervalTickTimestamp(intervalID = KLINTERVAL, timestamp = lr_klineTS, mrktReg = self.__currencies[ca['currencySymbol']]['kline_firstOpenTS'], nTicks = 1)
